...
def letter_grades(highest):
    ...
    """
    grades = []
    for i in range(41, highest, ((highest + 1 - 41)// 4 )):
        grades.append(i)
    return grades
...
def perfect_score(student_info):
    ...
    """
    first = []
    for nested_list in student_info:
        if nested_list[1] == 100:
            first = [item for item in nested_list]
            break
    return first    
